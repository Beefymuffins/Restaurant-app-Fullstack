...
const config = {
  ...
  // remember we said webpack sees everthing as modules and how different loaders are responsible for different file types? Here it is where we implement them. Pass it the rules for our JS and our styles
  module: {
